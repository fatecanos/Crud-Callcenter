...
public class ConhecimentoDAO {
	...
	public void excluir(Conhecimento conhecimento) {
		String sql = "DELETE tbConhecimento WHERE(idConhecimento=?)";
		PreparedStatement pstm = null;
	...
	public List<Conhecimento> listar(){
		String sql = "SELECT (idConhecimento, nome, descricao, tags"
				+ "idChamado, idUsuarioResponsavel) FROM tbConhecimento;";
		PreparedStatement pstm = null;
		ResultSet rs = null;
	...
	public Conhecimento buscarPorId(int id) {
		String sql = "SELECT * FROM tbConhecimento WHERE(idConhecimento=?);";
		PreparedStatement pstm = null;
		ResultSet rs = null;
