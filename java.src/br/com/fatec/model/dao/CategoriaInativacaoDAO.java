...
public class CategoriaInativacaoDAO {
	...
	public List<CategoriaInativacao> listar(){
		String sql = "SELECT (idCategoriaInativacao, nome) "
				   + "FROM tbCategoriaInativacao";
		PreparedStatement pstm = null;
		ResultSet rs = null;
	...
	public void alterar(CategoriaInativacao categoriaInativacao) {
		String sql = "UPDATE tbCategoriaInativacao "
				   + "SET(nome=?) "
				   + "WHERE(idCategoriaInativacao=?)";
		PreparedStatement pstm = null;
	...
	public void excluir(CategoriaInativacao categoriaInativacao) {
		String sql = "DELETE FROM tbCategoriaInativacao"
				   + " WHERE(idCategoriaInativacao=?)";
		PreparedStatement pstm = null;
